...
public final class PlacedBlocksState extends SavedData {
    ...
    public static PlacedBlocksState get(ServerLevel level) {
        return level.getDataStorage().computeIfAbsent(
                new SavedData.Factory<>(PlacedBlocksState::new, PlacedBlocksState::load, DataFixTypes.LEVEL),
                DATA_NAME
        );
    }
    ...
    private static PlacedBlocksState load(CompoundTag tag, HolderLookup.Provider registries) {
