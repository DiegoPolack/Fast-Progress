...
public final class FastProgressNetworking {
    ...
    private static void writeConfig(FriendlyByteBuf buf, ConfigData data) {
    ...
    private static ConfigData readConfig(FriendlyByteBuf buf) {
    ...
    private static void writeIdList(FriendlyByteBuf buf, List<ResourceLocation> ids) {
    ...
    private static List<ResourceLocation> readIdList(FriendlyByteBuf buf) {
    ...
    public static final class RequestConfigMessage extends BaseC2SMessage {
        ...
        public RequestConfigMessage(FriendlyByteBuf buf) {
        }
    ...
    public static final class UpdateConfigMessage extends BaseC2SMessage {
        ...
        public UpdateConfigMessage(FriendlyByteBuf buf) {
            this.data = readConfig(buf);
        }
    ...
    public static final class UpdateResultMessage extends BaseS2CMessage {
        ...
        public UpdateResultMessage(FriendlyByteBuf buf) {
