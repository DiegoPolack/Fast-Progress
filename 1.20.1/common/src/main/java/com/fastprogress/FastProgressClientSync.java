...
public final class FastProgressClientSync {
    ...
    public static boolean isServerSyncSupported() {
        return NetworkManager.canServerReceive(FastProgressNetworking.REQUEST_CONFIG.getId());
    }
    ...
    public static void requestServerConfig() {
        ...
        new FastProgressNetworking.RequestConfigMessage().sendToServer();
    }
    ...
    public static void sendUpdate(FastProgressConfig config) {
        new FastProgressNetworking.UpdateConfigMessage(FastProgressNetworking.ConfigData.fromConfig(config)).sendToServer();
    }
